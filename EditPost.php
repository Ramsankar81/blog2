...
if(isset($_POST["Submit"])){
	...
	if(empty($Title)){
	   ...
	   Redirect_to("AddNewPost.php");
		...
		$Query = "UPDATE admin_panel SET datetime='$DateTime',title='$Title',category='$Category',auther = '$Admin',image = '$Image',post = '$Post' WHERE id = '$EditFromURL'";
					...
					<div>
						...
						<?php
							...
							<div class="form-group">
								...
								<textarea  name="Post" id="postarea" cols="30" rows="10" class="form-control">
									<?php echo $PostToBeUpdated; ?>
								</textarea>
							</div>
								<input class="btn btn-primary form-control" type="Submit" value="Update Post"name="Submit">
							</fieldset>
						</form>
					</div>
